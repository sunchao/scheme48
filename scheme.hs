...
-- Writing a Scheme Interpreter in 48 Hours
...
-- Atom must start with a letter or symbol, but
-- can contain digits
...
-- Several alternatives. Interesting one is
-- parsing a list OR dotted list.
...
equal [arg1, arg2] = do
  primitiveEquals <- liftM or $ mapM (unpackEquals arg1 arg2)
                     [AnyUnpacker unpackNum, AnyUnpacker unpackBool,
